...
> several hundred files over ~48 lessons. The two things that determine whether that makes
...
The reference repo runs on this: 20 app ADRs + amendments in `docs/DECISIONS.md`. Every
