...
|------|------|------|-----|------|
| **Account & data lifecycle (GDPR)** — export + erasure | `GDPR` | M–L | Legal exposure; reuses dissolve (add `ExportAsync` beside `WipeAsync` on contributors) | audit ✅, File storage (W1) |
