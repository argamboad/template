...
| `docs/stories/e2e.md` | epic `E2E` ✅ COMPLETE — Playwright journeys for platform UI built unit/integration-first: E2E-1 RBAC roster (invite/join/promote/remove, permission-aware views); E2E-2 billing seat-quota 402 UX; E2E-3 notification bell/prefs. Health = DEPLOY-3 smoke, not a browser test |
