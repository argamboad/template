...
| `docs/stories/gdpr.md` | epic `GDPR` 🔲 in progress — tenant data export + account erasure on the contributor/dissolve/file-storage machinery (GDPR-1 export, GDPR-2 erasure); ADR-011 |
