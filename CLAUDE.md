...
| `docs/stories/files.md` | epic `FILES` 🔲 in progress — `IFileStorage` local/S3, tenant-scoped keys, signed URLs (FILES-1 abstraction, FILES-2 download, FILES-3 S3); ADR-010 |
