...
| `docs/stories/e2e.md` | epic `E2E` 🚧 — Playwright journeys for platform UI built unit/integration-first: E2E-1 ✅ RBAC roster; E2E-2 ✅ billing seat-quota 402 UX; E2E-3 ✅ notification bell/prefs; E2E-4 ✅ magic-link sign-in (happy + single-use); E2E-5 📝 membership lifecycle (transfer/leave/dissolve/delete-account). Health = DEPLOY-3 smoke, not a browser test |
...
| `docs/stories/native.md` | epic `NATIVE` 📝 PLANNED — full MAUI parity (Android/Windows/iOS/macOS): NATIVE-1 CI build gate + NATIVE-2 `docs/NATIVE_PARITY.md` audit; NATIVE-3/4/5 WebView gap-fixes; NATIVE-6 native QA pass + NATIVE-7 automated emulator smoke; NATIVE-8/9/10 signed AAB/MSIX/IPA/pkg + NATIVE-11 store submission; ADR-018 |
